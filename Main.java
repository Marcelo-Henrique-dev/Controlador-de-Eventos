...
public class Main {
    ...
    public static void main(String[] args) throws InvalidEventoTypeException {
        ...
        do {
            ...
            System.out.println(
                    "| 1 - Cadastra evento | 2 - Visualizar eventos | 3 - Editar Evento | 4 - Cancelar Evento |");
            System.out.println(
                    "| 5 - Cadastrar Participante | 6 - Listar Participantes | 7 - Editar Participantes | 8 - Apagar Participantes |");
